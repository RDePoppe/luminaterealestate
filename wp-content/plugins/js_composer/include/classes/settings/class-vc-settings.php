...
class Vc_Settings {
	...
	function adminLoad() {
		...
		$this->locale = array(
			...
			'vc_updater_already_activated' => __( 'License successfully activated. Thank you!', 'js_composer' ),
			...
			'wrong_username_api_key' => __( 'Wrong username and/or api key!', 'js_composer' ),
